                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <nav className="hidden md:flex items-center space-x-8">
                        {[
                            ...
                            { name: 'Channel Partner', active: false },
                            ...
                            >
                                <button className={`text-lg transition-colors duration-200 ${item.active
                ...
                {isMenuOpen && (
                    ...
                    >
                        <nav className="flex flex-col space-y-4">
                            {['Product', 'Features', 'Pricing', 'Resources', 'Company'].map((item) => (
                                <button key={item} className="text-gray-300 hover:text-white text-left transition-colors duration-200">
                                    {item}
                                </button>
                            ))}
                            <div className="pt-4 border-t border-gray-700 flex flex-col space-y-2">
                                <button className="text-gray-300 hover:text-white text-left transition-colors duration-200">
                                    Sign In
                                </button>
