        ...
        <section ref={ref} className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-950">
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    >
                        <span className="text-blue-400 font-medium">Flexible Pricing</span>
                    </motion.div>
                    ...
                    >
                        Scale your real estate business with our comprehensive CRM solutions.
                        From individual agents to enterprise organizations.
                    </motion.p>
                </motion.div>
                        ...
                        >
                            ...
                            {plan.popular && (
                                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                                    <div className="absolute -top-3 left-1/2 transform -translate-x-1/2 bg-gradient-to-r from-teal-500 to-emerald-500 text-white px-4 py-1 rounded-full text-sm font-medium">
                                        Most Popular
                                    </div>
                                </div>
                            )}

                            <div className={`h-full bg-gray-900/50 backdrop-blur-sm rounded-2xl p-6 border transition-all duration-300 ${plan.popular
                                ...
                                {/* CTA Button */}
                                <button className={`w-full py-3 px-6 rounded-lg font-semibold text-center transition-all duration-200 transform hover:scale-105 ${plan.popular
                                        ? 'bg-gradient-to-r from-teal-500 to-emerald-600 text-white hover:from-teal-600 hover:to-emerald-700 shadow-lg'
                                        : 'bg-gray-800 text-white hover:bg-gray-700 border border-gray-700 hover:border-teal-500'
                                    }`}>
